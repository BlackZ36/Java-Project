        ...
        while( exit != 0){
            switch(choice){
                ...
                case 'B':{
                    ...
                    while( !(c == c1 && l == l1) ){
                        System.out.println("\nThe Entered matrices is not valid, please re-enter: ");
                        System.out.print("Re-Enter row for 1st B arrays: ");
                        c = sc.nextInt();
                        System.out.print("Re-Enter column for 1st B arrays: ");
                        l = sc.nextInt();
                        b = new double[c][l];
                        System.out.print("--------\n");
                        System.out.print("Re-Enter row for 2nd B arrays: ");
                        c1 = sc.nextInt();
                        System.out.print("Re-Enter column for 2nd B arrays: ");
                        l1 = sc.nextInt();
                        bb = new double[c1][l1];
                    }
